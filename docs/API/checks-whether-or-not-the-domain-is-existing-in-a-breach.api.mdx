...
## Checks whether or not the domain is existing in a breach
...
Domain was found in a breach

</div><div></div></TabItem><TabItem label={"404"} value={"404"}><div>

Domain was not found in a breach
